...
import com.uni.bau.ui.Adapters.AnoucmentAdapter;
...
public class HomeFragment extends Fragment {
    ...
    private void getAnnounsemnet() {
        new BusinessManager().getAnnouncements(getActivity(), new ApiCallResponse() {
            @Override
            public void onSuccess(Object responseObject, String responseMessage) {
                swipeRefreshHome.setRefreshing(false);
                GetAnnouncementsModel[] studentClassificationsModel = (GetAnnouncementsModel[]) responseObject;
                AnoucmentAdapter adapter = new AnoucmentAdapter(getActivity(), studentClassificationsModel);
